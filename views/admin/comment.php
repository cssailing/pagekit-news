<?php $view->script('comment', 'news:app/bundle/comment-index.js', 'vue') ?>
...
<div id="comments" v-cloak>
    ...
    <div class="uk-margin uk-flex uk-flex--between uk-flex-wrap">
        <div class="uk-flex uk-flex-middle uk-flex-wrap">
            ...
            <h2 class="uk-margin-remove" v-if="!selected.length">{{ count }} {{ count > 1 ? 'Comments':'Comments' | trans }}</h2>
                ...
                <template v-if="editComment.id !== comment.id">
                    <tr class="check-item" :class="{'uk-active': active(comment)}" v-for="post in filterBy(posts, comment.post_id, 'id')">
                        ...
                        <td class="pk-blog-comments-padding">
                            <a :href="$url.route('admin/news/posts/edit', { id: post.id })">{{ post.title }}</a>
